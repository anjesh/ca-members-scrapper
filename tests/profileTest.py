...
class Profile1Test(unittest.TestCase):
    ...
    def testProfile1(self):
        ...
        self.assertEqual(profile.values[ProfileFields.CONTACT_MOBILE], profile.translateNumbers(ProfileFields.CONTACT_MOBILE,"9841338247"))
        self.assertEqual(profile.values[ProfileFields.CONTACT_EMAIL], "lammomthly@yahoo.com")
        self.assertEqual(profile.values[ProfileFields.CONTACT_PHONE_VALLEY], "")
        self.assertEqual(profile.values[ProfileFields.CONTACT_PHONE_DISTRICT], "")
